...
$cadena = ""; $totalprod=0; $totalprecio = 0; $cadenacant = ""; 
foreach($listaProductos as $Productos){
  $nomp = str_replace(' ', '_', $Productos);
 
 
  if(!empty($_POST[$nomp['nombre']]) || $_POST[$nomp['nombre']] == 0){/**verifico datos de los input */
    ...
    $totalprod = ($totalprod + $_POST[$nomp['nombre']]); /**tomo los datos de los input para sumar la cantidad de productos del pedido*/
 ...
 $factura = "****** FACTURA NUMERO  ".$num_fac[0]['id']." ****** <br> <br>"."Fecha Pedido  ". date("d")."/".date("m")."/".date("y")."<br> USUARIO  ".$_SESSION['USUARIO']."<br><br><br>";
